        ...
        <div className='container' style={style}>
            ...
            <div className="accordion" id="accordionExample" style={style}>
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse" style={style}  aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            ...
            <button className='btn btn-primary my-2' onClick={handleStyleChange}>{buttonState} Dark Mode</button>
        </div>
    )
}
